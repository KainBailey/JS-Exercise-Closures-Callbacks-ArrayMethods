...
1. In your own words, define closure (1-2 sentences). Closure is the combination of functions surrounding it. Closure gives you access to other functions that has been created.
